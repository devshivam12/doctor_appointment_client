...
const Signup = () => {
  ...
  const [privewURL, setPrivewURL] = useState("")
  ...
  return (
    <section className='px-[2rem] md:px-[2.7rem] lg:px-[10rem]'>
          ...
          <div className='rounded-l-lg lg:pl-16 py-10'>
            ...
            <form onSubmit={submitHandler}>
              ...
              <p className='mt-5 text-textColor text-center'>
                Already have and account? <Link to='/login' className='text-primaryColor'>Login</Link>
              </p>
